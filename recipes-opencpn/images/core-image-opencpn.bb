...
IMAGE_INSTALL_append = " mesa-driver-i965 man-pages sudo connman config-image-opencpn gpsd gpsd-udev libgpsd libgps gpsd-conf gpsd-gpsctl gps-utils python-pygps"
